...
export default function StatusIndicator({
  ...
  return (
    <div className="fixed top-4 right-4 z-[9999] flex items-center gap-3 backdrop-blur-md bg-black/60 px-4 py-2.5 rounded-full border border-white/10 shadow-2xl">
